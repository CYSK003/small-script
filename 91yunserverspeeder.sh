...
#bin下载地址
BIN=http://soft.91yun.org/soft/serverspeeder/bin/CentOS/7.1/3.10.0-229.1.2.el7.x86_64/x64/3.10.61.12/serverspeeder_2727
...
rv=CentOS_7.1_3.10.0-229.1.2.el7.x86_64
...
echo "开始下载bin运行文件。。。。"
echo "======================================"
curl $BIN -o 91yunserverspeeder/apxfiles/bin/acce-3.10.61.0-[CentOS_7.1_3.10.0-229.1.2.el7.x86_64] || { echo "下载bin运行文件失败，请检查";exit 1; }
